local Settings = {
    ...
    ["Default Whitelisted"] = {"dawninja21alt"}, -- People whitelisted by default
    ...
    ["Script Name"] = "Solar.lua", -- Change the name of the script, default "ii' s St upid Ad min"
...
addCommand("gb",{"player"},function(args)
...
addCommand("ungb",{"player"},function(args)
    local Player = GetPlayers(args[1])
    for i,v in pairs(Player) do
        pcall(function()
